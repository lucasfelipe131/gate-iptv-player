const CACHE = "gate-player-v12";
const ASSETS = ["/", "/styles.css?v=0.5.1", "/app.js?v=0.5.1", "/gate-icon.svg", "/manifest.webmanifest", "/vendor/hls.min.js?v=0.5.1", "/vendor/mpegts.min.js?v=0.5.1"];
