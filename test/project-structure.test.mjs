...
test("mantém os produtos separados e publica o hotfix webOS 0.6.3", async () => {
  ...
  assert.equal(JSON.parse(web).version, "0.6.2");
  assert.match(android, /versionName '0\.6\.2'/);
  assert.equal(JSON.parse(webos).version, "0.6.3");
  assert.match(tizen, /version="0\.6\.2"/);
});
